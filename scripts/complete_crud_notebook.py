...
def create_complete_crud_notebook():
    """Crear el notebook completo de consultas CRUD con las 15 consultas"""
...
if __name__ == "__main__":
    # Crear notebook CRUD completo
    crud_notebook = create_complete_crud_notebook()
    with open("notebooks/Consultas_CRUD.ipynb", "w", encoding="utf-8") as f:
        json.dump(crud_notebook, f, indent=2, ensure_ascii=False)
    
    print("✅ Notebook CRUD completo creado exitosamente!")
    print("- notebooks/Consultas_CRUD.ipynb (con las 15 consultas)") 
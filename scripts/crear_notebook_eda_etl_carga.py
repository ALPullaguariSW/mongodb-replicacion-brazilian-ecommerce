#!/usr/bin/env python3
"""
Generador de Notebook: EDA, ETL y Carga a MongoDB
Crea un Jupyter notebook completo con todo el proceso de datos
"""
...
def create_notebook_eda_etl_carga():
    """Crear notebook completo de EDA, ETL y Carga"""
    ...
    # Celda 5: Cargar datos y análisis básico
    notebook["cells"].append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Celda 7: Análisis de relaciones entre tablas
    notebook["cells"].append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Celda 10: Limpieza de geolocalización
    notebook["cells"].append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Celda 11: Procesamiento de órdenes
    notebook["cells"].append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Celda 14: Carga a MongoDB - Conexión
    notebook["cells"].append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Celda 16: Carga de órdenes (optimizada)\n",
    notebook["cells"].append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Celda 17: Verificación final y estadísticas
    notebook["cells"].append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
...
if __name__ == "__main__":
    print("🚀 CREANDO NOTEBOOK: EDA, ETL Y CARGA")
    print("="*80)
    
    # Crear notebook
    notebook = create_notebook_eda_etl_carga()
    
    # Guardar
    file_path = save_notebook(notebook, "01_EDA_ETL_Carga_MongoDB.ipynb")
